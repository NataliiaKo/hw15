        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10">
                <div class="about-content">
                    <img src="http://blog.test/img/blog-img/18.jpg" alt="">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <img src="http://blog.test/img/blog-img/19.jpg" alt="">
                        </div>
                        <div class="col-12 col-md-6">
                            <img src="http://blog.test/img/blog-img/20.jpg" alt="">
                        </div>
                    </div>
                    ...
                    <div class="signature">
                        <img class="mb-0" src="http://blog.test/img/core-img/signa.png" alt="">
                    </div>
                </div>
            </div>
        </div>
