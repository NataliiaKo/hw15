                    ...
                    <div class="blog-posts-area">
                        ...
                        <div class="single-post-details-area">
                            <div class="post-thumbnail mb-30">
                                <img src="http://blog.test/img/blog-img/1.jpg" alt="">
                            </div>
                            <div class="post-content">
                                ...
                                <blockquote>
                                    <div class="blockquote-icon">
                                        <img src="http://blog.test/img/core-img/quote.png" alt="">
                                    </div>
                        ...
                        <div class="related-posts clearfix">
                            <!-- Line -->
                            <div class="curve-line bg-img mb-50" style="background-image: url(http://blog.test/img/core-img/breadcrumb-line.png);"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="single-blog-post related-post">
                                        ...
                                        <div class="post-thumbnail mb-50">
                                            <a href="#"><img src="http://blog.test/img/blog-img/13.jpg" alt=""></a>
                                        </div>
                                        <!-- Content -->
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="single-blog-post related-post">
                                        <!-- Thumbnail -->
                                        <div class="post-thumbnail mb-50">
                                            <a href="#"><img src="http://blog.test/img/blog-img/14.jpg" alt=""></a>
                                        </div>
                                        <!-- Content -->
                                        <div class="post-content mb-50">
                            ...
                            <!-- Line -->
                            <div class="curve-line bg-img" style="background-image: url(http://blog.test/img/core-img/breadcrumb-line.png);"></div>
                        </div>
                            ...
                            <ol>
                                ...
                                <li class="single_comment_area">
                                    <div class="comment-wrapper d-flex">
                                        ...
                                        <div class="comment-author">
                                            <img src="http://blog.test/img/blog-img/15.jpg" alt="">
                                        </div>
                                        <!-- Comment Content -->
                                    ...
                                    <ol class="children">
                                        <li class="single_comment_area">
                                            <div class="comment-wrapper d-flex">
                                                <!-- Comment Meta -->
                                                <div class="comment-author">
                                                    <img src="http://blog.test/img/blog-img/16.jpg" alt="">
                                                </div>
                                                <!-- Comment Content -->
                                                <div class="comment-content">
                                                    <span class="comment-date">27 Aug 2018</span>
                                ...
                                <li class="single_comment_area">
                                    <div class="comment-wrapper d-flex">
                                        <!-- Comment Meta -->
                                        <div class="comment-author">
                                            <img src="http://blog.test/img/blog-img/17.jpg" alt="">
                                        </div>
                                        <!-- Comment Content -->
                                        <div class="comment-content">
                                            <span class="comment-date">27 Aug 2018</span>
