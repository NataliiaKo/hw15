    ...
    <section class="hero-area">
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url(http://blog.test/img/blog-img/2.jpg);"></div>
                <!-- Post Content -->
            ...
            <div class="single-hero-post">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url(http://blog.test/img/blog-img/3.jpg);"></div>
                <!-- Post Content -->
                <div class="hero-slides-content">
            ...
            <div class="single-hero-post">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url(http://blog.test/img/blog-img/4.jpg);"></div>
                <!-- Post Content -->
                <div class="hero-slides-content">
            ...
            <div class="single-hero-post">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url(http://blog.test/img/blog-img/5.jpg);"></div>
                <!-- Post Content -->
                <div class="hero-slides-content">
            ...
            <div class="single-hero-post">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url(http://blog.test/img/blog-img/6.jpg);"></div>
                <!-- Post Content -->
                <div class="hero-slides-content">
                    <p>MAY 8, 2018 / foody</p>
                    <a href="#" class="post-title">
                    ...
                    <div class="featured-post-area">
                        <div id="featured-post-slides" class="carousel slide d-flex flex-wrap" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item active bg-img" style="background-image: url(http://blog.test/img/blog-img/7.jpg)">
                                ...
                                <div class="carousel-item bg-img" style="background-image: url(http://blog.test/img/blog-img/6.jpg)">
                                    <!-- Featured Post Content -->
                                    <div class="featured-post-content">
                                        <p>MAY 8, 2018 / foody</p>
                                        <a href="#" class="post-title">
                                ...
                                <div class="carousel-item bg-img" style="background-image: url(http://blog.test/img/blog-img/2.jpg)">
                                    <!-- Featured Post Content -->
                                    <div class="featured-post-content">
                                        <p>MAY 8, 2018 / foody</p>
                                        <a href="#" class="post-title">
                                ...
                                <div class="carousel-item bg-img" style="background-image: url(http://blog.test/img/blog-img/3.jpg)">
                                    <!-- Featured Post Content -->
                                    <div class="featured-post-content">
                                        <p>MAY 8, 2018 / foody</p>
                                        <a href="#" class="post-title">
                                ...
                                <div class="carousel-item bg-img" style="background-image: url(http://blog.test/img/blog-img/5.jpg)">
                                    <!-- Featured Post Content -->
                                    <div class="featured-post-content">
                                        <p>MAY 8, 2018 / foody</p>
                                        <a href="#" class="post-title">
                    ...
                    <div class="blog-posts-area">
                        ...
                        <div class="single-blog-post d-flex flex-wrap mt-50">
                            ...
                            <div class="post-thumbnail mb-50">
                                <a href="#"><img src="http://blog.test/img/blog-img/8.jpg" alt=""></a>
                            </div>
                            <!-- Content -->
                            ...
                            <!-- Post Curve Line -->
                            <img class="post-curve-line" src="http://blog.test/img/core-img/post-curve-line.png" alt="">
                        </div>
                        ...
                        <div class="single-blog-post d-flex flex-wrap mt-50">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail mb-50">
                                <a href="#"><img src="http://blog.test/img/blog-img/9.jpg" alt=""></a>
                            </div>
                            <!-- Content -->
                            <div class="post-content mb-50">
                        ...
                        <div class="single-blog-post d-flex flex-wrap mt-50">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail mb-50">
                                <a href="#"><img src="http://blog.test/img/blog-img/10.jpg" alt=""></a>
                            </div>
                            <!-- Content -->
                            <div class="post-content mb-50">
                        ...
                        <div class="single-blog-post d-flex flex-wrap mt-50">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail mb-50">
                                <a href="#"><img src="http://blog.test/img/blog-img/11.jpg" alt=""></a>
                            </div>
                            <!-- Content -->
                            <div class="post-content mb-50">
                        ...
                        <div class="single-blog-post d-flex flex-wrap mt-50">
                            <!-- Thumbnail -->
                            <div class="post-thumbnail mb-50">
                                <a href="#"><img src="http://blog.test/img/blog-img/12.jpg" alt=""></a>
                            </div>
                            <!-- Content -->
                            <div class="post-content mb-50">
                    ...
                    <div class="post-sidebar-area">
                        ...
                        <div class="single-widget-area">
                            ...
                            <div class="about-thumbnail">
                                <img src="http://blog.test/img/blog-img/about-me.jpg" alt="">
                            </div>
                            <!-- Content -->
                            <div class="widget-content text-center">
                                <img src="http://blog.test/img/core-img/signature.png" alt="">
                        ...
                        <div class="single-widget-area">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="http://blog.test/img/blog-img/lp1.jpg" alt="">
                                </div>
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="http://blog.test/img/blog-img/lp2.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="http://blog.test/img/blog-img/lp3.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="http://blog.test/img/blog-img/lp4.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="http://blog.test/img/blog-img/lp5.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                        ...
                        <div class="single-widget-area">
                            <!-- Adds -->
                            <a href="#"><img src="http://blog.test//img/blog-img/add.png" alt=""></a>
                        </div>
